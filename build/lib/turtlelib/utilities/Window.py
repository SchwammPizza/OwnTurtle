...
class Window:
    ...
    def resetWindow(self) -> None:
        """
        Deletes all drawings on the plane
    ...
    def setAnimation(self, animation: bool) -> None:
        """
        Set if the turtle has to show the way it draws or not.
    ...
    def setSpeed(self, speed: int) -> None:
        """
        Set the speed which the turtle uses to draw if the animation is activatet.
    ...
    def setTurtleColor(self, rgbValues: tuple[float]) -> None:
        """
        Set the color which the turtle uses to draw.
    ...
    def show(self, wait: int = 1) -> None:
        """
        Shows the plane with the drawings
