...
class Turtle:
    ...
    def left(self, angle: float) -> None:
        """
        Turns the Turtle it by the given Value counterclockwise
    ...
    def right(self, angle: float) -> None:
        """
        Turns the Turtle it by the given Value clockwise
    ...
    def penUp(self) -> None:
        """
        The Turtle stop to draw if it moves
    ...
    def circle(self, radius: float, degrees: float = 360) -> None:
        """
        Draws an circle. If the radius is negative, the middlepoint of the circle is 90° left from the turtleheading, else right.
